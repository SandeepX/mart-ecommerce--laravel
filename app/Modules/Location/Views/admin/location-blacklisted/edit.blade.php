                        ...
                        @include("Admin::layout.partials.flash_message")
                                ...
                                <div class="box-body">
                                    <div class="row col-md-6" style="margin-left: 200px;">
                                        <form class="form-horizontal" role="form" id="editBlackListedLocation" action="{{route($base_route.'.update',$blackListedLocationDetail->blacklisted_location_hierarchy_code)}}" enctype="multipart/form-data" method="post">
                                            @method('put')
                                            @csrf
                                            <div class="box-body">
                                                <div class="form-group" id="select_province">
                                                    ...
                                                    <select class="form-control select2" name="province" id="province" >
                                                        <option value="{{$locationTree['province']['location_code']}}">{{$locationTree['province']['location_name']}}</option>
                                                ...
                                                <div class="form-group " id="select_district">
                                                    ...
                                                    <select class="form-control select2"  name="district" id="district" >
                                                        <option value="{{$locationTree['district']['location_code']}}">{{$locationTree['district']['location_name']}}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group " id="select_municipality">
                                                    ...
                                                    <select class="form-control select2" name="municipality" id="municipality" >
                                                        <option value="{{$locationTree['municipality']['location_code']}}">{{$locationTree['municipality']['location_name']}}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group " id="select_ward">
                                                    ...
                                                    <select class="form-control select2" name="location_code" id="ward" required >
                                                        <option value="{{$locationTree['ward']['location_code']}}">{{$locationTree['ward']['location_name']}}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="purpose" required>
                                                        <option {{($blackListedLocationDetail->purpose =='store-registration')? 'selected':''}} value ="store-registration">Store Registartion</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="status" required>
                                                        <option {{($blackListedLocationDetail->status =='1')? 'selected':''}} value ="1">Active</option>
                                                        <option {{($blackListedLocationDetail->status =='0')? 'selected':''}} value ="0">Inactive</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="box-footer">
                                                <button type="submit" style="width: 49%;margin-left: 17%;" class="btn btn-block btn-primary editBlackListedLocation">Update</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editBlackListedLocation').submit(function (e, params) {
                ...
                Swal.fire({
                    title: 'Are you sure you want to edit BlackListed Location  ?',
