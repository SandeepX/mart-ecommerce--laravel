                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="{{route('admin.stores.misc-payments-detaillog.matched.show',[$store->store_code,$paymentFor])}}" method="get">
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-3">
                                        <a href="{{route('admin.stores.misc-payments-detaillog.show',[$store->store_code,$paymentFor])}}" class="btn btn-danger form-control">Clear</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                List of Matched Miscellaneous Payments :
