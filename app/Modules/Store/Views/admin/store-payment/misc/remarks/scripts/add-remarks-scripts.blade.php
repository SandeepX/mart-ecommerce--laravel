<script>
    ...
    $('#formMiscPaymentRemarks').submit(function (e) {
        e.preventDefault();
        Swal.fire({
    ...
    function saveRemarksToPayment(){
        var formAction = $('#formMiscPaymentRemarks').attr('action');
        var formMethod = $('#formMiscPaymentRemarks').attr('method');

        let miscPaymentRemarksData = new FormData(document.getElementById("formMiscPaymentRemarks"));
        $.ajaxSetup({
            headers:
