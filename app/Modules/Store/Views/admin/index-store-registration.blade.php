                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="{{route('admin.stores.store-registration.unapproved')}}" method="get">
                ...
                <div class="col-xs-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 title="List of stores which are not yet approved : pending stores,processing stores" class="panel-title">
                                List of Unapproved {{ formatWords($title,true)}}
                            </h3>
                            ...
                            <table class="table table-bordered table-striped" cellspacing="0" width="100%">
                                ...
                                @forelse($stores as $i => $store)
                                    <tr>
                                        ...
                                        <td>
                                            {{--                                        <a class="fancybox"><img src="{{asset($store->getLogoUploadPath().$store->store_logo)}}" alt="Store Logo" width="50" height="50" /></a>--}}
                                        ...
                                        {{--                                    <td>{{$store->registrationType->registration_type_name}}</td>--}}
                                        {{--                                    <td>{{$store->companyType->company_type_name}}</td>--}}
...
{{--                                                    @endcan--}}
                                                    ...
                                                    {{--                                            @can('Delete Store')--}}
                                                    {{--                                            <li>--}}
                                                    {{--                                                {!! \App\Modules\Application\Presenters\DataTable::makeDeleteAction('Delete',route('admin.stores.destroy',$store->store_code),$store,'Store',$store->store_name)!!}--}}
                                                    {{--                                            </li>--}}
