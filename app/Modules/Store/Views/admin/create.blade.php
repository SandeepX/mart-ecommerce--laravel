                            ...
                            <div class="panel-heading">
                                <div class="text-left">
                                    <h3 class="panel-title">
                                        <b>New Store Registration Form</b>
                                        &nbsp;
                                    </h3>
...
@push('scripts')
    @includeIf('Store::admin.scripts.store-script');

    <script>
        $('#store_form').submit(function (e, params) {
            ...
            Swal.fire({
                title: 'Are you sure you want to create store detail  ?',
