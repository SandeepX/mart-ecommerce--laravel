                ...
                <div class="col-xs-12">
                    ...
                    <div class="box-body">
                        ...
                        <!-- /.row -->
                                ...
                                <div class="col-xs-12 table-responsive">
                                    ...
                                    @if(isset($taxableOrderProducts) && count($taxableOrderProducts) > 0)
                                        <div class="panel panel-danger">
                                            ...
                                            @endif
                                            <div class="panel-body">
                                                @include('Store::admin.store-preorder.show-partials.order-taxable-products')
                                            </div>
                                        </div>
                                        <hr>
                                    @endif
                                    @if(isset($nonTaxableOrderProducts) && count($nonTaxableOrderProducts) > 0)
                                        <div class="panel panel-primary">
                                            ...
                                            @endif
                                            <div class="panel-body">
                                                @include('Store::admin.store-preorder.show-partials.order-non-taxable-products')
                                            </div>
                                        </div>
                                    @endif
                            ...
                            @include(''.$module.'.admin.store-preorder.show-partials.status-log')
