                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel panel-default collapse" id="collapseFilterPayment" style="background-color: #E4E4E4">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="miscellaneous_filter_form" action="{{route('admin.store.miscellaneous.payment.show',['storeCode'=>$storeCode,'paymentFor'=>$paymentFor])}}" method="GET">
                                        <div class="col-xs-3">
                            ...
                            <table class="table table-bordered table-striped" cellspacing="0" width="100%">
                                ...
                                @forelse($storePayments as $i => $storePayment)
                                    <tr>
                                        ...
                                        <td>{{$storePayment->payment_for}}</td>
