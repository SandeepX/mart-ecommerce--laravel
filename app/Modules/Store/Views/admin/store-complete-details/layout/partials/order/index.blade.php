        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default collapse" id="collapseFilter" style="background-color: #E4E4E4">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="order_filter_form" action="{{route('admin.store.order',['storeCode'=>$storeCode])}}" method="GET">
                                <div class="col-xs-3">
                               ...
                               <div class="col-xs-3">
                                ...
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-primary" id="order-filter-btn">View Orders</button>
                                </div>
                            </div>
                        ...
                        @forelse($storeOrders as $i => $storeOrder)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a>
                                        <button data-toggle="modal" value="{{$storeOrder->store_order_code}}" data-url="{{route('admin.store.order.details',['storeOrderCode'=> $storeOrder->store_order_code])}}" data-target="#modal-target1" id="order_view_btn" data-placement="left" data-tooltip="true" title="Details" class="btn btn-xs btn-info">
...
{{--        <div class="row">--}}
{{--            <div class="col-md-12 text-center">--}}
{{--                <a href="#general" data-toggle="tab" aria-expanded="true" class="btn btn-default" type="button">Previous</a>--}}
{{--                <a href="#miscellaneous" data-toggle="tab" aria-expanded="true" class="btn btn-primary">Next</a>--}}
{{--            </div>--}}
{{--        </div>--}}
    </div>
</div>
