...
{{--                        <p style="margin-left: 10px;">Updated information: <a href="#">2 min ago</a></p>--}}
            ...
            <div class="panel panel-default collapse" id="collapseFilter" style="background-color: #E4E4E4">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="pre_order_filter_form" action="{{route('admin.store.pre-order',$storeCode)}}" method="GET">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <button id="pre-order-filter-btn" type="submit" class="btn btn-block btn-primary form-control">Filter</button>
                                    </div>
                                </div>
                            </form>                        </div>
                    </div>
                    ...
                    <table class="table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        @forelse($preOrdersListing as $i => $preOrder)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a>
                                        <button data-toggle="modal" value="{{$preOrder->store_preorder_code}}" data-target="#modal-target1" id="preorder_view_btn" data-placement="left" data-tooltip="true" title="Details" class="btn btn-xs btn-info">
