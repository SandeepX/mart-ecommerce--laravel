                    ...
                    <form class="form-horizontal" role="form" id="changeStorePassword" action="{{route('admin.store-password.update',$storeAdmin->user_code)}}" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">User: {{$storeAdmin->name}}</label>
                            </div>
...
{{--                                    @if ($errors->has('password_confirmation')) <p style="color:red;">{{ $errors->first('password_confirmation') }}</p> @endif<br>--}}
                        ...
                        <div class="box-footer">
                            <button type="submit" style="width: 49%;margin-left: 17%;" class="btn btn-block btn-primary updateStorePasswordBtn" id="updateStorePasswordBtn">Update</button>
                        </div>
                    </form>
                </div>
            </div>
