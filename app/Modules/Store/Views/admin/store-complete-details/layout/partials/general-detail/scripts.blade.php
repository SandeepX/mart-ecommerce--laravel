<script>
    // // $('body #changeStorePassword').submit(function (e, params) {
    //     $(document).on('submit','#changeStorePassword', function(e,params) {
    ...
    $(document).on('submit','#changeStorePassword', function(e,params) {
        ...
        Swal.fire({
            title: 'Are you sure you want to change store-password ?',
            showCancelButton: true,
            confirmButtonText: `Yes`,
            padding: '10em',
            width: '500px'
                ...
                $.ajax(
                    {
                        ...
                        beforeSend:function(){
                            // $(document).find('span.error-text').text('');
                            $("#updateStorePasswordBtn").prop('disabled', true);
                            Swal.fire({
                                title: 'Please wait...',
                                hideClass: {
                                    popup: ''
