...
use App\Modules\Store\Models\StorePackageTypes\StorePackageUpgradeRequest;
...
class StoreUpgradeRequestRepository
{
    ...
    {
        try {
            return StorePackageUpgradeRequest::create($validatedData);
        } catch (Exception $e) {
            throw $e;
        }
    }
