...
class CreateStoreTypePackageHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('store_type_package_history', function (Blueprint $table) {
            ...
            $table->primary(['store_type_package_history_code'],'pk_stph_stphc');
            $table->foreign('store_type_package_master_code','stpmc')->references('store_type_package_master_code')->on('store_type_package_master');
        ...
        DB::statement('ALTER Table store_type_package_history add id BIGINT NOT NULL UNIQUE AUTO_INCREMENT FIRST');
    }
    ...
    {
        Schema::dropIfExists('store_type_package_history');
    }
}
