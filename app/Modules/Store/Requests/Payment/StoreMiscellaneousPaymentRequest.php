...
class StoreMiscellaneousPaymentRequest extends FormRequest
{
    ...
    {
        $rules= [
            'payment_for' => ['required',Rule::in(StoreMiscellaneousPayment::PAYMENT_FOR)],
            'payment_type' => ['required',Rule::in(StoreMiscellaneousPayment::PAYMENT_TYPE)],
