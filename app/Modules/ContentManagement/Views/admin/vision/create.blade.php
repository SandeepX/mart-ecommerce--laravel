            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" role="form" id="addvision-mission" action="{{route($base_route.'.store')}}" enctype="multipart/form-data" method="post">
                                {{csrf_field()}}
...
@push('scripts')
    ...
    <script>
        $('#addvision-mission').submit(function (e, params) {
            ...
            Swal.fire({
                title: 'Are you sure you want to add new Vission and Mission  ?',
