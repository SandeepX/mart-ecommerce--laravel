...
class CreateStorePreOrderRejectedItemReportRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('store_pre_order_rejected_item_report', function (Blueprint $table) {
            ...
            $table->foreign('store_preorder_detail_code','Spdc-Spir')->references('store_preorder_detail_code')->on('store_preorder_details');
            ...
            $table->foreign('product_variant_code','pvc-sprir')->references('product_variant_code')->on('product_variants');
            $table->foreign('package_code')->references('package_code')->on('package_types');
            $table->foreign('product_packaging_history_code','pph-sprir')->references('product_packaging_history_code')->on('product_packaging_history');
    ...
    {
        Schema::dropIfExists('store_pre_order_rejected_item_report');
    }
}
