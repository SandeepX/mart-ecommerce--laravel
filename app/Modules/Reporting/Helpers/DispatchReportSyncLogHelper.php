...
class DispatchReportSyncLogHelper
{

    public static function getLastDispatchSyncDateAndStatus(){
        $normalOrderLastSync = DispatchReportSyncLog::where('order_type','normal_order')->orderBy('id','DESC')->first();
        $preOrderLastSync = DispatchReportSyncLog::where('order_type','preorder')->orderBy('id','DESC')->first();
