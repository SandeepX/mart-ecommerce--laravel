                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="{{route('admin.wallet.transactions.manager.details',$wallet->wallet_code)}}" method="get">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div style="font-size:15px" class="panel-title">
                                <span>Transactions of  Sales Manager :{{$wallet->holder_name}} / {{$wallet->wallet_holder_code}}</span>
                            ...
                            <table class="table table-bordered table-striped" cellspacing="0" width="100%">
                                ...
                                @forelse($allTransactionByWalletCode as $i => $allTransaction)
                                    <tr>
                                        ...
                                        <td>
                                            {{getNumberFormattedAmount($allTransaction->balance)}}
                                        </td>
