...
class InvestmentPlanDetailResourceForManager extends JsonResource
{
    ...
    public function toArray($request)
    {
        $data = [
            ...
            'investment_commission_detail' => new InvestmentPlanCommissionCollection($this->activeInvestmentCommissionDetail),
        ];
        return $data;
    }
}
