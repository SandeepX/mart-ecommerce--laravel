...
namespace App\Modules\SupportAdmin\Providers;


use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Auth;

class SupportAdminNotificationShareProvider extends ServiceProvider
{
    /**
    ...
    {
        view()->composer('SupportAdmin::layout.partials.nav-bar', function ($view) {
