                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="{{route('admin.online-payments.lists')}}" method="get">
                                ...
                                <a style="margin-left: 5px;margin-top: 5px;" href="{{route('admin.online-payments.lists')}}" class="btn btn-danger btn-sm pull-left">Clear</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($list->status ==='pending')
                                                ...
                                                <a class="btn btn-info btn-xs reverify" href="{{route('admin.online-payments.reverify.connect-ips',
                                                  ['storeCode'=>$list->initiator_code,'transactionId'=>$list->transaction_id])}}">
