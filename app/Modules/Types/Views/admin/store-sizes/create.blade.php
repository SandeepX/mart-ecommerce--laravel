            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" id="addStoreSize" role="form" action="{{route($base_route.'.store')}}" enctype="multipart/form-data" method="post">
                                {{csrf_field()}}

                                <div class="box-body">

                                    @include(''.$module.'.admin.store-sizes.common.form')
...
@push('scripts')
    ...
    <script>
        $('#addStoreSize').submit(function (e, params) {
