            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" role="form" id="categoryTypeAdd" action="{{route($base_route.'.store')}}" enctype="multipart/form-data" method="post">
                                {{csrf_field()}}
...
@push('scripts')
    ...
    <script>
        $('#categoryTypeAdd').submit(function (e, params) {
