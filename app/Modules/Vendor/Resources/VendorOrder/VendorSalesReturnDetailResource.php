...
class VendorSalesReturnDetailResource extends JsonResource
{
    /**
    ...
    {
        return [
            'warehouse_purchase_return_code' => $this->warehouse_purchase_return_code,
            ...
            'warehouse'=>$this->warehouseOrder->warehouse,
            'product'=>$this->warehouseOrderDetail->product,
            'product_variant'=>$this->warehouseOrderDetail->productVariant,
        ];
    }
}
