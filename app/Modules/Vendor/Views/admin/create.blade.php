                    ...
                    <div class="box box-primary">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-left">
                                    <h3 class="panel-title">
                                        <b>New Vendor Registration Form</b>
                                        &nbsp;
                                    </h3>
                            ...
                            <div class="panel-body">
                                <form id="vendor_form" enctype="multipart/form-data" method="POST">
                                    {{-- @csrf --}}
...
{{--    <script>--}}
{{--        $('#vendor_form').submit(function (e, params) {--}}
...
{{--            Swal.fire({--}}
{{--                title: 'Are you sure you want to store this vendor detail ?',--}}
