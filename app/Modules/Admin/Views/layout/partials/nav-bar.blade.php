<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ route('admin.dashboard') }}" class="logo" style="height: 52px !important;">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav" id="admin-search-menu" style="padding-top: 10px; padding-right: 400px;">
                <input class="form-control mr-sm-2"
                    ...
                    <div class="card card-admin-search" data-toggle="" style="width: 18rem; position: absolute !important;">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="{{route('admin.notifications.index')}}">See All</a></li>
                    </ul>
                </li>
            </ul>
...
@include('Admin::layout.partials.admin-menu-search-scripts')
