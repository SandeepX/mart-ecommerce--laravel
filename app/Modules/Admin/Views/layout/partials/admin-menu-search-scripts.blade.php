...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#nav-search").on("keyup", function (e) {
                ...
                if (searchQuery.length >= 0) {
                    ...
                    if (searchQuery) {
                        for (i = 0; i < linkKeys.length; i++) {
                            ...
                            if (linkKeys[i].toLowerCase().indexOf(searchQuery) > 0) {
                                $('#nav-search-listing').
                                append( '<li id="nav-menu" class="nav-listing list-group-item">' +
                                    '<a href=" '+hreflocation+' ">'+linkKeys[i].toUpperCase()+'</a></li>');
            ...
            var listItems = document.querySelectorAll("#nav-search-listing li");
            ...
            if(keycode == keyEnter){
                var url = $('.highlight').find('a').attr('href');
