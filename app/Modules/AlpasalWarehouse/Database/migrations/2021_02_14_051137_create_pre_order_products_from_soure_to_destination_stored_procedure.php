...
class CreatePreOrderProductsFromSoureToDestinationStoredProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure ="
            CREATE PROCEDURE `preorderProductsFromSourceToDestination`(sourcePreorderListingCode varchar(255), destinationPreorderListingCode varchar(255),Created_by varchar(255))
            ...
            SELECT
                ...
                wpp.mrp,
                wpp.admin_margin_type,
                wpp.admin_margin_value,
                wpp.wholesale_margin_type,
                wpp.wholesale_margin_value,
                wpp.retail_margin_type,
                wpp.retail_margin_value,
                wpp.is_active
                    FROM warehouse_preorder_products as wpp
                    WHERE wpp.warehouse_preorder_listing_code collate utf8mb4_unicode_ci = sourcePreorderListingCode;
            ...
            REPEAT
               ...
               where warehouse_preorder_listing_code collate utf8mb4_unicode_ci =destinationPreorderListingCode
               and
               ...
               case
                 when hasValue = 0 then
                    ...
                    warehouseppc,
                    destinationPreorderListingCode,
                    product_code_var,
                    product_variant_code_var,
                    mrp_var,
                    admin_margin_type_var,
        ...
        DB::unprepared("DROP procedure IF EXISTS preorderProductsFromSourceToDestination");
