                        ...
                        <table class="intro-table">
                            <tr style=" vertical-align: top;">
                                ...
                                <td align="right">
                                    ...
                                    <p>Date of bill issue: {{date('Y-m-d')}}</p>
                            ...
                            @foreach($fullOrderDetail['store_order_details'] as $storeOrderDetail)
                                <tr>
                                    ...
                                    <td width="25%">
                                        ...
                                        (B.L:{{$storeOrderDetail['package_order']}})
                                        ={{$storeOrderDetail['package_micro_quantity']}}pcs.

                                    </td>
                                    <td width="5%">{{$storeOrderDetail['quantity']}}</td>
                                    <td width="12%">{{roundPrice($storeOrderDetail['unit_rate'])}}</td>
                                    <td width="15%">{{roundPrice($storeOrderDetail['subtotal'])}}</td>
                                </tr>
                            @endforeach
