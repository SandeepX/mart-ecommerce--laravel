<script>
    $(document).ready(function () {
       ...
       var productsVariantDetail=[];
        ...
        //load package types on variant change
        $(document).on('change','select.select2_product_variant',function (e) {
            ...
            $.ajax({
                ...
                packageCodeSelectOption.append('<option value="" selected readonly disabled>Select Package Type</option>');
          ...
          //  var variantSelectInput=closestTr.find('select.select2_product_variant');
            ...
            if(quantity){
                ...
                if(variantDetail['has_variants']){
                    if(packageSelectInput.val()){ //if variant selected
        ...
        function insertNewRowInProductOrderListTable(productDetail) {
           ...
           // console.log(productOrderListTable.rows.length);
            ...
            if(productHasVariants){
                variantInputContent.insertAdjacentHTML('afterbegin','<option value="" selected readonly disabled>Select Variant</option>');
                ...
                packageCodeInputContent.insertAdjacentHTML('afterbegin','<option value="" selected readonly>Select Package Type</option>');
            }
            else{
