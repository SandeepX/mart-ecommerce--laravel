                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            @include(''.$module.'warehouse.current-stock.common.filter-form-show')
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="pull-right" style="margin-top: -35px;margin-left: 10px;">
                            <a href="{{route('warehouse.vendor-wise.current-stock.exportExcellVendorWiseProductStockReport',$vendor->vendor_code)}}"
                            ...
                            <a href="{{ route('warehouse.vendor-wise.current-stock.index') }}" style="border-radius: 0px; " class="btn btn-sm btn-info">
