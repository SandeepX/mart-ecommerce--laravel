<div class="col-xs-12 col-md-3">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="destination_warehouse_name" id="warehouse_name" value="{{$filterParameters['destination_warehouse_name']}}">
    </div>
</div>
<div class="col-xs-12 col-md-3">
    <div class="form-group">
...
<div class="col-xs-12 col-md-3">
    <div class="form-group">
        <label for="transaction_date_to">Transaction Date To</label>
