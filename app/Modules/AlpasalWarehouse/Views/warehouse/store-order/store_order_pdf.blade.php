...
{{--                        --}}
                        <p>Transaction Date: {{$fullOrderDetail['transaction_date']}}</p>
                         <p>Date of bill issue: {{$fullOrderDetail['date_of_bill_issue']}}</p>
            ...
            <table>
                ...
                @foreach($fullOrderDetail['store_order_details'] as $storeOrderDetail)
                    <tr>
                        ...
                        <td width="25%">
                            {{$storeOrderDetail['ordered_package_name'] ?? $storeOrderDetail['unit']}}
                ...
                <tr>
                    <td colspan="2" align="right">
                        Tax Amount ({{ roundPrice($fullOrderDetail['vat'])}}%)
                    </td>
