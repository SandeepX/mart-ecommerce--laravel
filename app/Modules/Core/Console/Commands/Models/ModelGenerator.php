...
class ModelGenerator
{
    ...
    {
        return app_path().'/Modules/Core/Console/Commands/Models/stubs';
    }
    ...
    {
        return file_get_contents($this->getStubPath().'/model.stub');
    }
    ...
    protected function populateStub($name, $stub,$module)
    {
        ...
        $new = [$this->getClassName($name),"App\\Modules\\{$module}\\Models"];
