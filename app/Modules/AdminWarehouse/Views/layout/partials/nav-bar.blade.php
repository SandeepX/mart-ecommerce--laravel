<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ route('warehouse.dashboard') }}" class="logo" style="height: 52px !important;">

        Alpasal - Warehouse Admin
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="{{route('warehouse.notifications.index')}}">See All</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" style="margin-right: 10px;">
                    ...
                    <ul class="dropdown-menu">
                       ...
                       <li class="m_2">
                            <a href="{{ route('warehouse.changePassword') }}">
