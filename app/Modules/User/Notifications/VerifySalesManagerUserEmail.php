...
class VerifySalesManagerUserEmail extends VerifyEmail
{
//    use Queueable;
    ...
    public function sendEmailUrl($notifiable)
    {
        ...
        $emailUrl = config('site_urls.ecommerce_site')."/sales-manager-registration/verify/email-address"."?".$queryString.'&id='.$this->userId.'&hash='.$this->hash;
        return $emailUrl;
    }
