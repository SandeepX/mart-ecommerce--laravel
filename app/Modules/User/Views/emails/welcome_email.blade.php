...
<body>
    <div class="template">
        ...
        <div class="a2">
            You have been successfully enrolled as the {{$userType}} on our {{config('app.name')}}.
            Please find your login credentials below and don't forget to change password as soon as you login.
        </div>
