...
@section('content')
    <div class="content-wrapper">
        ...
        'icon'=>'home',
        'sub_icon'=>'',
        'manage_url'=>route('admin.warehouses.index'),
        ])
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" role="form" id="changeWarehousePassword" action="{{route('admin.warehouse-password.update',$warehouse->user_code)}}" method="post">
                                {{csrf_field()}}
                                @method('PUT')
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">User: {{$warehouse->name}}</label>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <button type="submit" style="width: 49%;margin-left: 17%;" class="btn btn-block btn-primary updateWarehousePassword">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        $('#changeWarehousePassword').submit(function (e, params) {
