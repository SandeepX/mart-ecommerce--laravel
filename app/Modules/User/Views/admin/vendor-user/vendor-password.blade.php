...
@section('content')
    <div class="content-wrapper">
        ...
        'icon'=>'home',
        'sub_icon'=>'',
        'manage_url'=>route('admin.vendors.index'),
        ])
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" role="form" id="updateVendorPassword" action="{{route('admin.vendor-password.update',$vendorAdmin->user_code)}}" method="post">
                                {{csrf_field()}}
                                @method('PUT')
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">User: {{$vendorAdmin->name}}</label>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <button type="submit" style="width: 49%;margin-left: 17%;" class="btn btn-block btn-primary changeVendorPassword">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        $('#updateVendorPassword').submit(function (e, params) {
            ...
            Swal.fire({
                title: 'Are you sure you want to change vendor-password ?',
