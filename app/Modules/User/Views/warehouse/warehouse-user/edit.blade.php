            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" role="form" action="{{route($base_route.'update',$user->user_code)}}" enctype="multipart/form-data" method="post">
                                @method('PUT')
                                @csrf

                                <div class="box-body">

                                    @include(''.$module.'warehouse.warehouse-user.common.form')
